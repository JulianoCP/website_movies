            ...
            <table class="table text-center table-sm table-bordered">
              <thead>
                <tr>
                  ...
                  <th scope="col" style="color:red">FORMATOS</th>
              ...
              <tbody>
                ...
                if ($result->num_rows > 0) {
                  ...
                  while($row = $result->fetch_assoc()) {
                    echo "<tr>
                    <th scope='row'>".$row["idFormato"]."</th>
                    <td>".$row["Nome"]."</td>
                    <td class='text-center'>
                    <button id='edi' type='button' name='button' onclick='edi(this.id, ".$row["idFormato"].")'><i class='fas fa-edit'></i></button>
                    <button id='delete' type='submit' name='button' onclick='acao(this.id, ".$row["idFormato"].")'><i class='fas fa-trash-alt'></i></button>
                    </div></td>
                    </tr>";
